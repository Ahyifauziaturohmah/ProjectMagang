      ...
      <div class="bg-white rounded-lg shadow-lg overflow-x-auto border-4 border-[#6DC6FF]">
        <table class="min-w-full text-left border-collapse">
          <thead class="bg-white">
            <tr>
              <th class="px-6 py-3 font-semibold border border-gray-200">Tugas</th>
              <th class="px-6 py-3 font-semibold border border-gray-200">Date Due</th>
              <th class="px-6 py-3 font-semibold border border-gray-200">Status</th>
              <th class="px-6 py-3 font-semibold border border-gray-200">Eval</th>
            </tr>
          </thead>
          <tbody>
